...
<div class="container">
	<form action="${linkTo[ClientesController].add(null) }">
		<fieldset>
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="nome">Nome</label> <input type="text"
						name="cliente.nome" id="nome" class="form-control"
						placeholder="NOME DO ADMINISTRADOR" maxlength="40" required
						onkeyup="this.value = this.value.toUpperCase();" value="${recuperaNome }">
				</div>
				<div class="form-group col-md-6">
					<label for="email">E-mail</label> <input type="email"
						name="cliente.email" id="email" class="form-control"
						placeholder="NOME DO ADMINISTRADOR" maxlength="40" required value="${recuperaEmail }">
				</div>
			</div>
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="cpf">CPF</label> <input type="text" name="cliente.cpf"
						id="cpf" class="form-control" placeholder="CPF DO ADMINISTRADOR"
						maxlength="20" value="" required onblur="TestaCPF(this)"
						onFocus="TestaCPF(this)" value="${recuperaCpf }">
				</div>
				<div class="form-group col-md-6">
					<label for="rg">RG</label> <input type="text" name="cliente.rg"
						id="rg" class="form-control" placeholder="RG DO ADMINISTRADOR"
						required value="${recuperaRg }">
				</div>
			</div>
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="telefone">Telefone</label> <input type="text"
						...
						placeholder="TELEFONE DO ADMINISTRADOR" required value="${recuperaTelefone }">
				</div>
				<div class="form-group col-md-6">
					<label for="dtNascimento">Data de nascimento</label> <input
						type="text" name="cliente.dtNascimento" id="dtNascimento"
						class="form-control"
						placeholder="DATA DO NASCIMETO DO ADMINISTRADOR" required value="${recuperaData }">
				</div>
			</div>
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="senha">Senha</label> <input type="password"
						...
						placeholder="SENHA DO ADMINISTRADOR" required value="${recuperaSenha}"> <input
